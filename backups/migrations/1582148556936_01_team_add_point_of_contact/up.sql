...
CREATE TABLE public.teams (
    ...
    "pointOfContactUserId" integer NOT NULL
);
...
ALTER TABLE ONLY public.teams
    ADD CONSTRAINT "teams_pointOfContactUserId_fkey" FOREIGN KEY ("pointOfContactUserId") REFERENCES public.users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
